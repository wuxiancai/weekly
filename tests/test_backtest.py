...
class BacktestTests(unittest.TestCase):
    ...
    def test_page_has_independent_defaults_for_symbol_and_interval(self) -> None:
        ...
        self.assertIn('<option value="15m">15m</option>', HTML)
        self.assertIn('<option value="4h">4h</option>', ETH_HTML)
        self.assertIn('<option value="1h">1h</option>', ETH_HTML)
        self.assertIn('<option value="15m">15m</option>', ETH_HTML)
        ...
        self.assertIn("volumeMult: 0.75", HTML)
        ...
        self.assertIn("ema: 34, ma: 89", HTML)
        self.assertIn("ema: 21, ma: 60", HTML)
        self.assertIn("adx: 45, longRsiMin: 55, longRsiMax: 85", HTML)
        self.assertIn("adx: 35, longRsiMin: 45, longRsiMax: 80", HTML)
        self.assertIn("stopAtr: 0.8, takeAtr: 10.0, takeAtrStep: 2.0, takeAtrMax: 24.0", HTML)
        self.assertIn("volumeMult: 1.75", HTML)
        self.assertIn("rangeAdxMax: 18, rangeBbWidthMax: 0.04, rangeRsiLow: 25, rangeRsiHigh: 70", HTML)
